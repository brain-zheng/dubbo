...
public class RegistryConfig extends AbstractConfig {
    ...
    /**
     * 对应URL参数 < host:port >  注册中心服务器地址
     * 如果地址没有端口缺省为9090，同一集群内的多个地址用逗号分隔，如：ip:port,ip:port
    ...
    /**
     * 对应URL参数< port>
     * 注册中心缺省端口(9090)，当address没有带端口时使用此端口做为缺省值
     */
    ...
    /**
     * 对应URL参数 < protocol>
     * 注册中心地址协议，支持dubbo, multicast, zookeeper, redis, consul(2.7.1)
     * sofa(2.7.2), etcd(2.7.2), nacos(2.7.2)等协议
     */
    ...
    // 服务是否动态注册，如果设为false，注册后将显示为disable状态，需人工启用
